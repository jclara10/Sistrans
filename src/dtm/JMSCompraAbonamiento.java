...
public class JMSCompraAbonamiento implements MessageListener, ExceptionListener
{
	 ...
	 */
	public final static String GET_ALL_ABONOS_ASK = "GETALLAbonamientos";

	/**
	 * Atributo que representa, dentro del mensaje, la respuesta del requerimiento dar todos los videos.
	 */
	public final static String GET_ALL_ABONOS_REPLY = "GETALLAbonamientosRES";
	 ...
	 */
	public static JMSCompraAbonamiento darInstacia(FestivAndesTransactionManager festivAndesMaster){
	...
	public void sendMessage() throws JMSException, NamingException{
		...
		txtMsg.setText(GET_ALL_ABONOS_ASK + CONNECTOR + this.myQueue);
	...
	public void onMessage(Message message)
	{
		...
		try 
		{
			...
			if(a[0].equals(GET_ALL_ABONOS_ASK) && !a[1].equals(this.myQueue)){
				...
				doResponseToQueue(a[1], GET_ALL_ABONOS_REPLY + CONNECTOR + jsonString);
			}
			else if(a[0].equals(GET_ALL_ABONOS_REPLY)){
				ObjectMapper mapper = new ObjectMapper();
				if(waiting){
